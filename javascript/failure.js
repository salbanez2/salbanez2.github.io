...
var question2 = prompt("On a scale of 1-5 how much did you feed me?");
 ...
 if ( score  > 60) {
		...
		document.write ( "<p>	Corn is the worst for many reasons, but mostly because it is in everything. Additionally, I don't feel it in my ears until it's too late. Please tell me so that I can use my inhaler. If you have it, I want a benedryl. My ears are probably itching slightly, but I won't be sure why yet. Later, there will be a heavy pain in my chest. Im going to feel weak for the next day.</p>");
	} else if ( score  > 43) {
		document.write ( "<p>	Corn is the worst for many reasons, but mostly because it is in everything. Additionally, I don't feel it in my ears until it's too late. Please tell me so that I can use my inhaler. I may go home and take a benedryl before it hurts. I'm going to feel weak for a few hours.</p>");
	} else if ( score  > 42) {
...
document.write('<p>Refresh the page to test another allergen.</p>')
